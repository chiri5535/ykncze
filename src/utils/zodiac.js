export const getZodiacSign = (month, day) => {
  const signs = [
    ...
    { 
      ...
      lucky: '会話運とひらめきを明るくするアプリコットイエロー',
